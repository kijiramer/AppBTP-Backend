...
with_node \
  ...
  --target "/Users/mehdiakounad/Desktop/ApplicationBTP/AppBTP/ios/Pods/Target Support Files/Pods-AppBTP/ExpoModulesProvider.swift" \
  --entitlement "/Users/mehdiakounad/Desktop/ApplicationBTP/AppBTP/ios/AppBTP/AppBTP.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-splash-screen"
